...
// Curated biodiversity catalog for Philippine mountains
// Only species endemic to the Philippines or found in supported mountains
...
// Mountain biodiversity information
export interface MountainBiodiversity {
  id: string;
  name: string;
  curatedSpeciesCount: number;
  description: string;
...
export const MOUNTAIN_BIODIVERSITY: MountainBiodiversity[] = [
  {
    ...
    endemicSpeciesCount: 48,
    keySpecies: ['Rafflesia speciosa', 'Visayan Hornbill', 'Panay Monitor Lizard'],
  ...
  },
  {
    ...
    endemicSpeciesCount: 52,
    keySpecies: ['Guiting-Guiting Forest Frog', 'Romblon Hawk-Eagle', 'Negros Bleeding-heart'],
  ...
  },
  {
    ...
    endemicSpeciesCount: 38,
    keySpecies: ['Benguet Pine', 'Philippine Deer', 'Cloud Rat'],
  ...
  },
  {
    ...
    endemicSpeciesCount: 67,
    keySpecies: ['Philippine Eagle', 'Warty Pig', 'Nepenthes attenboroughii'],
  ...
  },
  {
    ...
    endemicSpeciesCount: 29,
    keySpecies: ['Albay Forest Frog', 'Mayon Montane Forest Mouse', 'Philippine Tarsier'],
  ...
  },
  {
    ...
    endemicSpeciesCount: 44,
    keySpecies: ['Negros Fruit Dove', 'Visayan Warty Pig', 'Flame-templed Babbler'],
    ecosystem: 'Dipterocarp and montane forests',
    conservationStatus: 'National Park',
  },
];

// Curated Philippine endemic species catalog
export const CURATED_SPECIES: CuratedSpeciesData[] = [
  // Mt. Madjaas Featured Species
  {
    species: {
      id: 1,
  ...
  // Mt. Guiting-Guiting Featured Species
  {
    species: {
      id: 4,
  ...
  // Mayon Volcano Featured Species
  {
    species: {
      id: 13,
  ...
  // Additional curated species for multiple mountains
  {
    species: {
      id: 19,
...
// Helper functions for curated species
